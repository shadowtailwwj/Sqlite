...
//数据连接配置
define('SQLitePath', "E:/YsEip/WebSite/YsDev/DB/YsSetting.db");//响应代码，100-199为正常
...
//站点配置
define('SitePath', '/');//不同站点文件夹位置不同，需要重新配置
define('LogPath', 'E:/YsEip/WebSite/YsDev/');//站点日志文件夹位置，可写绝对地址，斜杠结尾
