...
function UserToReg($OpenId){
    return '感谢关注测试323公众号，你的openID='.$OpenId;//openid
}

function UserToUnReg($OpenId){
    return '解除关注的openID='.$OpenId;//openid
}
...
class Wechat{
     ...
     * @return string
     */
    public static function UserReg($object)
    {
        $contentStr = "";
        switch ($object->Event)
        {
     ...
     * @return string
     */
    public static function ReturnKeys($postObj)
    {
        $ReturnMsg="请输入关键字...";
     ...
     * @return array
     */
    public static function pushMessage($OpenId,$ModuleId,$Url,$data = [],$topcolor = '#0000'){
        $template = [
            'touser'      => $OpenId,
